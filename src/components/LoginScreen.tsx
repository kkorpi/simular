    ...
    <div className="flex h-dvh bg-bg1">
      ...
      <div className="hidden flex-1 flex-col items-center justify-center px-16 lg:flex xl:px-24">
        <div className="w-full max-w-[480px]">
            ...
            {proofPoints.map((point, i) => (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="text-[11px] text-t3">{point.detail}</div>
                </div>
          ...
          <p className="mt-6 text-center text-[12px] text-t3">
      ...
      <div className="flex flex-1 items-center justify-center px-8 lg:flex-none lg:w-[440px] lg:border-l lg:border-b1 lg:bg-bg2/30">
        <div className="w-full max-w-[340px]">
          ...
          <p className="mt-1.5 text-[14px] leading-[1.6] text-t2">
          ...
          <p className="mt-4 text-center text-[12px] leading-[1.6] text-t3">
            ...
            <span className="font-medium text-t2">Terms of Service</span> and{" "}
            <span className="font-medium text-t2">Privacy Policy</span>
          </p>

          {/* Trust signals */}
          <div className="mt-8 flex items-center gap-4 text-[11px] text-t3">
