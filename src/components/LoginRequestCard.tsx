...
export function LoginRequestCard({
  ...
  if (connected) {
    return (
      <div className="mt-2">
        ...
        >
          <div className="max-w-[480px] overflow-hidden rounded-xl border border-g/30 bg-g/[0.04]">
            <div className="flex items-center gap-3.5 px-4 py-3.5">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-g/15">
  ...
  return (
    <div className="mt-2 max-w-[480px] overflow-hidden rounded-xl border border-b1 bg-bg3/50">
      <div className="flex items-center gap-3.5 px-4 py-3.5">
        {/* LinkedIn logo */}
      ...
      <div className="flex items-center justify-between border-t border-b1 px-4 py-2.5">
        ...
        <button
          onClick={onLogin}
          className="rounded-lg bg-[#0A66C2] px-3.5 py-1.5 text-[12px] font-medium text-white transition-all hover:brightness-110"
        >
          Sign in to {service}
        </button>
      </div>
