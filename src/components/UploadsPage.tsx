...
const mockUploads: UploadItem[] = [
  ...
  {
    id: "3",
    title: "series-a-deck-draft.pdf",
    type: "PDF",
    size: "8.4 MB",
    preview: "document",
    previewContent: "Acme Ventures\nSeries A Overview\n\nInvestment Strategy & Track Record\n\nTarget: $80M · Focus: Series A & B\nSectors: AI Infrastructure, Developer Tools, Vertical SaaS",
    conversation: "Weekly competitor digest",
  },
  {
    id: "4",
    title: "Services Agreement - Draft.docx",
    type: "DOCX",
    size: "42 KB",
    preview: "text",
    previewContent: "SERVICES AGREEMENT\n\nThis SERVICES AGREEMENT (this \"Agreement\") is made and entered into as of the Effective Date set forth below by and between Acme Corp, Inc., a Delaware corporation (\"Client\"), and the undersigned party (\"Consultant\").",
    previewLines: 110,
    conversation: "Research inbound founder",
  },
  {
  ...
  {
    id: "7",
    title: "Brand Identity Brief.txt",
    type: "TXT",
    size: "8 KB",
    preview: "text",
    previewContent: "Our company was founded by leaders with firsthand experience in enterprise software and data infrastructure. Drawing on decades of expertise, our team is committed to developing solutions that help customers harness their data to drive better business outcomes.",
    previewLines: 113,
    conversation: "Research inbound founder",
  },
  {
    id: "8",
    title: "Meeting Notes - March.txt",
    type: "TXT",
    size: "4 KB",
    preview: "text",
    previewContent: "Investor Meeting Notes\nMarch 2026\n\nAttendees: Katie Chen, Board Members\n\nAgenda:\n1. Portfolio performance update\n2. New deal pipeline review\n3. Fund deployment timeline\n4. Q&A",
    previewLines: 45,
    conversation: "Research inbound founder",
  },
];
