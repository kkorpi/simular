...
/** Service icon using favicon from the service's domain */
function ServiceIcon({ service }: { service: ServiceConfig }) {
  return (
    <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-md bg-bg3 overflow-hidden">
      <img
        src={`https://www.google.com/s2/favicons?domain=${service.trustDomain}&sz=64`}
        alt={service.name}
        className="h-5 w-5"
      />
    </div>
